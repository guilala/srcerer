...
const loadApplicationConfiguration = function(next) {
   ...
   // conf less
   this.lessConfSrc = confLess(false);
   this.lessConfWww = confLess(false);
...
const serveRoot = function(next) {
   ...
   if(this.debug) {
      if(!this.runtime.apps[this.build].hasOwnProperty("serveStaticSrc")) {
         this.runtime.router.use(this.urlBase, this.runtime.static(this.staticRoot));
         this.runtime.apps[this.build].serveStaticSrc = true;
      }
   }

   // express serve static www
   else {
      if(!this.runtime.apps[this.build].hasOwnProperty("serveStaticWww")) {
         this.runtime.router.use(this.urlBase, this.runtime.static(this.staticRoot));
         this.runtime.apps[this.build].serveStaticWww = true;
      }
   }
