...
(function(){
   ...
   var confNginx = function(next){
      console.log("nginx");
      if(app.nginx && app.nginx != server.lastConfNginx){
         server.runtime.lastConfNginx = app.nginx;
   ...
   var loadApplicationConfiguration = function(next) {
      ...
      this.appRoot = this.server.root;
      this.appRoot += this.server.appsRoot;
      this.appRoot += this.build + "/";
