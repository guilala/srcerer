...
(function(){
   ...
   // ensure static blob root exits
   var makeStaticBlobRoot =  function(next){
      var exists = false;
   ...
   var configureBlobs = function(next) {
      ...
      // get all blobs
      var blobsToConfigure = util.All(this);
