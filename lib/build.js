...
const blobExport = function(done) {
   ...
   if (this.css) {
      writeFiles.add(function(ready){
         fs.writeFile(this.blobRoot + this.name + ".css", this.css, "utf8", ready);
      });
   ...
   if (this.svg) {
      writeFiles.add(function(ready){
         fs.writeFile(this.blobRoot + this.name + ".svg", this.svg, "utf8", ready);
      });
   ...
   if (this.mvc) {
      writeFiles.add(function(ready){
         if(this.debug){
            this.mvc = "//# sourceURL=" + this.name + "\n" + this.mvc;
         }
         fs.writeFile(this.blobRoot + this.name + ".js", this.mvc, "utf8", ready);
      });
