...
(function(){
   ...
   // conditions
   var checkConditions = function(resolve){
      if(
         conf &&
         conf.domain
      ) resolve();
   ...
   // configure express
   var configureExpress = function(resolve){
      app = express();
   ...
   var enableMountPoints = function(resolve){
   ...
   // reply
   var enableReply = function(resolve){
      router.use(function (req, res, next) {
         if(res.respond){
            // parse response
   ...
   module.exports = function(confIn){
      ...
      new util.Que(this)
      .push(checkConditions)
      .push(configureExpress)
      .push(enableMountPoints)
      .push(enableReply)
